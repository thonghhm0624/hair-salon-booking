                        ...
                        <ul class="nav nav-pills nav-stacked">
                            <li><?=
                                $this->Form->postLink(
                                    ...
                                    ['action' => 'delete', $collection->id],['escape' => false,'confirm' => __('Are you sure you want to delete # {0}?', $collection->id)]
                                )
                                ?>
                            </li>
                            <li>
        ...
        <div class="col-md-9">
            ...
            <div class="form-group">
                <div class="form-group" id="group-image">
                    ...
                    <?php echo $this->JqueryUpload->upload('image', 'upload',$collection->image); ?>
                </div>
            </div>
