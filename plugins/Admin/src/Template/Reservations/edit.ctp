...
<div class="reservations form">
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="form-group"><?php echo $this->Form->input('reservation_date',['class'=>'form-control datepicker','placeholder' => 'Reservation Date']);  ?></div>
            <div class="form-group">
                <label for="reservation-status">Time</label>
            ...
            <div class="form-group">
                <label for="reservation-status">Stylist</label>
                <?php echo $this->Form->select('stylist_id',$stylists,['class'=>'form-control','placeholder' => 'Stylist Id']);  ?>
            </div>
            <div class="form-group">
                <label for="reservation-status">Service</label>
